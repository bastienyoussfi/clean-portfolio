...
export const workExperiences: WorkExperience[] = [
  {
    ...
    achievements: [
      "Developed an application that automatizes meeting transcripts and summarys using AI.",
      "Developed an application that automatically extracts data from a CV and turns it into ready-to-use data.",
      "Supported development for various client's websites.",
    ...
    link: {
      ...
      description: "slogan steamulo",
    },
  },
  {
    id: 2,
    company: "Digital Surf",
    position: "Software Developer Intern at Digital Surf",
    period: "February 2023 - August 2023",
    description:
      "The company is a leader in their field, they have a strong expertise and try to always push boundaries with their software. Digital Surf is a real company of passionate people",
    logo: (
      <svg
        version="1.0"
        xmlns="http://www.w3.org/2000/svg"
    ...
    achievements: [
      "Dived into research to learn about microscopy state of the art and problems.",
      "Created an add-on to automate surface recognition.",
      "Implemented the add-on into the actual software.",
      "Provided detailed documentation and customer support on the new add-on.",
    ],
    link: {
      ...
      description: "slogan digital surf",
    },
  },
  {
    id: 3,
    company: "Steamulo",
    position: "Research intern at G-SCOP Lab",
    period: "June 2022 - August 2022",
    description:
      "The laboratory is full of science passionate. Researchers there are inspiring and curious, leading to a good climate to push the limits of research.",
    logo: (
      <svg
        version="1.0"
        xmlns="http://www.w3.org/2000/svg"
    ...
    achievements: [
      "Researched about the Travel Salesman Problem, one of the most infamous optimization problem.",
      "Developed a solver to this problem using Java.",
      "Analyzed the solver's performances using a benchmark.",
      "Wrote and published a paper on how this solver was developed.",
    ],
  },
];
