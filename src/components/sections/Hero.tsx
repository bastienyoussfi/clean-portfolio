        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <motion.p
              ...
              className="text-secondary dark:text-gray-400 mb-8 max-w-2xl"
            >
            ...
            >
              <a
                ...
                className="inline-flex items-center space-x-2 text-secondary hover:text-primary dark:hover:text-white transition-colors"
              >
              ...
              <a
                href="https://instagram.com/elianagarcia997"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-2 text-secondary hover:text-primary dark:hover:text-white transition-colors"
              >
